...
class TeacherProgressListActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.teacher_student_progress_list)
        ...
        val studentName = intent.getStringExtra("studentName") ?: "Unknown"
        nameTextExpanded.text = "$studentName"
